/*This example shows a simple robot WITHOUT INTERRUPTS. This is not recommended since your robot will do everything in the loop routine
Made by #noFear (Tenea Mihai). All the thanks go the founder of this great library - #noName (Ciobanu Laurentiu) :)
*/

#include <SumoRobot.h>

char n = 'B'; //the initial of robot's name
// will be useful in the next version of the lib.

char iMode = 'N';//The intrerrups and timer modes.
...
void loop(){
  //the robot will do EVERYTHING here!!
